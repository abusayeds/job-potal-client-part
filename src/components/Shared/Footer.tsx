    ...
    <footer className="bg-[#002710]">
      <div className="container mx-auto px-2 lg:px-4 py-12 lg:py-16 xl:py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-x-8 gap-y-8">
          <div className="space-y-3 flex flex-col items-center pt-7">
            ...
            <div className="flex justify-center gap-3 pt-2">
              {shareLinks.map((link, index) => (
                <button className="text-blue-400 hover:text-blue-500 border border-white/10 p-1.5 rounded-full cursor-pointer" key={index} >
                  <link.icon size={17} />
                  {/* {link.label} */}
                </button>
              ))}
