      ...
      {employeeOrSeeker === "employee" ? (
        ...
        >
          <div className="w-full py-10 lg:py-14 drop-shadow-lg px-4">
            <Image
              src={"/statics/work-process/employee-process.svg"}
              alt="hero"
              width={1000}
              height={1000}
            ...
            />
            <Image
              src={"/statics/work-process/employee-process-sm.svg"}
              alt="hero"
              width={1000}
              height={1000}
        ...
        >
          <div className="w-full py-10 lg:py-14 drop-shadow-lg px-4">
            <Image
              src={"/statics/work-process/seeker-process.svg"}
              alt="hero"
              width={1000}
              height={1000}
              className="w-full h-auto hidden lg:block"
            />
            <Image
              src={"/statics/work-process/seeker-process-sm.svg"}
              alt="hero"
              width={1000}
              height={1000}
              className="w-full h-auto lg:hidden"
