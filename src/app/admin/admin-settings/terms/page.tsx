...
import { useGetTermsQuery } from "@/redux/features/settings/settings.api";
...
const Page = () => {
  ...
  // ]);
  const { data, isLoading, isError, error } = useGetTermsQuery({});
  // console.log(data);
  return (
    <div className="">
      ...
      <div className="p-4 min-h-[calc(100vh-200px)] flex flex-col justify-between">
        ...
        <div className="flex justify-end pt-10">
          <Link href={"terms/edit"} className="w-full max-w-[250px]">
            <Button
              size="large"
              htmlType="submit"
              type="primary"
