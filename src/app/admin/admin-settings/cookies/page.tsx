...
import { useGetCookiesQuery } from "@/redux/features/settings/settings.api";
import { Button } from "antd";
import Link from "next/link";
import { use } from "react";

const Page = () => {
  const { data, isLoading, isError, error } = useGetCookiesQuery({});
  return (
    <div className="">
      ...
      <div className="p-4 min-h-[calc(100vh-200px)] flex flex-col justify-between">
        ...
        <div className="flex justify-end pt-10">
          <Link href={"cookies/edit"} className="w-full max-w-[250px]">
            <Button
              size="large"
              htmlType="submit"
              type="primary"
