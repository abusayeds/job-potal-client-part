...
import { useGetAllVerifiedCompanyQuery } from "@/redux/features/company/company.api";
...
const Page = () => {
  ...
  const { data, isLoading, isError, error } =
    useGetAllVerifiedCompanyQuery(queryParams);
      ...
      >
        {jobDatas?.length === 0 ? (
          <div className="h-full min-h-[70vh] flex justify-center items-center">
            <p className="text-2xl text-center">No verified account!</p>
          </div>
        ) : (
          <Companies
            jobDatas={jobDatas}
